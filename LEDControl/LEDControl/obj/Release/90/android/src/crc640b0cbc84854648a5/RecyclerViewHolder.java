...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("LEDControl.Adapters.RecyclerViewHolder, LEDControl", RecyclerViewHolder.class, __md_methods);
	}
	...
	public RecyclerViewHolder (android.view.View p0)
	{
		...
		if (getClass () == RecyclerViewHolder.class)
			mono.android.TypeManager.Activate ("LEDControl.Adapters.RecyclerViewHolder, LEDControl", "Android.Views.View, Mono.Android", this, new java.lang.Object[] { p0 });
	}
